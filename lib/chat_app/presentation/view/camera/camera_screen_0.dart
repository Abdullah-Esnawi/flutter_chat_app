...
import 'package:whatsapp/chat_app/presentation/view/camera/widgets/camera_screen_appbar.dart';
                      ...
                      children: [
                        ...
                        GestureDetector(
                          ...
                          onLongPressUp: () async {
                            ...
                            if (!mounted) return;
                            Navigator.pushNamed(context, Routes.pickedImageView, arguments: {
                              'path': file.path,
