...
import 'package:whatsapp/chat_app/presentation/view/chat/widgets/recording_mic_widget.dart';
...
// final isRecorderInit = StateProvider.autoDispose<bool>((ref) => true);
...
class _BottomChatFieldState extends ConsumerState<BottomChatField> {
  ...
  //   ref.read(isRecorderInit.notifier).state = false;
  // }
  ...
  //   //   RecordingPermissionException('Microphone permission not Allowed');
  //   // }

  //   soundRecorder!.openRecorder();
  //   ref.read(isRecorderInit.notifier).state = true;
  // }
