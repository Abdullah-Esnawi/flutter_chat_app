...
import 'package:whatsapp/data/repository/auth_repository.dart';
...
class AuthViewmodel with BaseAuthViewmodel {
  ...
  void verifyOTP(BuildContext context, String verificationId, String userOTP) {
    authRepository.verifyOTP(context: context, verificationId: verificationId, userOTP: userOTP, phone: phoneController.text);
  }
}
