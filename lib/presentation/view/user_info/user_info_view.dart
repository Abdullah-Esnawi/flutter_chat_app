...
import 'package:whatsapp/presentation/view/chat/mobile_layout_screen.dart';
                  ...
                  Stack(
                    children: [
                      snapshot.data?.profilePic == null
                          ...
                          : CircleAvatar(
                              backgroundImage: (image != null ? FileImage(image!) : NetworkImage(snapshot.data!.profilePic!))
                                  as ImageProvider,
                              radius: 64,
                            ),
                      Positioned(
